...
const PaginaPrincipal = () => {
    return(
        ...
        <div>
            <p className="lg:text-3xl lg:mx-72 lg:my-24 sm:my-10 italic sm:text-center md:mx-16 sm:mx-12 md:text-center sm:text-xl ">Bem-vindo à Clínica de Consultas Ágil, onde oferecemos um atendimento excepcional e o melhor sistema de agendamento. Nossa plataforma inovadora permite que você marque suas consultas de forma rápida e fácil, garantindo flexibilidade e conveniência. </p>
        </div>
